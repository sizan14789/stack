...
export default function ChatBox() {
  ...
  return (
    <div className="border-t-[.5px] border-t-[var(--border)] h-[4rem] sm:h-[5rem] p-4 flex">
      <div className="flex gap-4 justify-center items-center w-full">
        <div className="flex">
          <div className="cursor-pointer rounded-xl hover:bg-[var(--text-primary)] hover:text-[var(--background)] p-2 duration-200 border-[.5px]">
            <CiImageOn className="sm:text-2xl font-bold " />
          </div>
        </div>
        <form className="flex gap-4 justify-self-end" onSubmit={handleTextSending}>
          <input
            type="text"
            placeholder="text"
            name="message"
          ...
          <button
            type="submit"
            className="cursor-pointer p-2 sm:p-3 aspect-square flex justify-center items-center rounded-full bg-[var(--accent)] text-[var(--background)]"
          >
